 ...
 * 
 */
@WebServiceClient(name = "ImageProcessingImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:5050/api/v1/images?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:5050/api/v1/images?wsdl");
